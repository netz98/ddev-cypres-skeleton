...
```
cd existing_repo
git remote add origin https://git.netz98.de/belvini/cypress-testing.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.netz98.de/belvini/cypress-testing/-/settings/integrations)
